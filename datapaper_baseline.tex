...
\end{tabular}
\caption{Tracking result for one video with one frame for each day. $(a)$ Example frames in the video. $(b)$. Leaf label result overlaid with tip locations. $(c)$ Leaf tracking result. We show one frame for each day. }
