...
As $\tau$ keep increasing, {\it{ULR}} approaches a constant value, which is the the different number in leaf counting that results from both miss detection and false alarms.
