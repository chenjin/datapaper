...
In the case of the bean plant, the pixel association between modalities is more difficult as the within-plant depth variations are large.  
...
To evaluate the performance of leaf segmentation, alignment, tracking, and counting, we use $4$ performance metrics, whose Matlab implementations will be provided along with the data.
