...
In our experiments we observed a flat, uniform albedo surface (\todo{Danial: Please define ``albedo" here as from Comment $38$}) perpendicular to the camera at a sequence of depths, and for each depth acquired $300$ images.
